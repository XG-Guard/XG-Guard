...
def parse_arguments():
    ...
    parser.add_argument("--gnn_checkpoint_path", default="ckpt/MA-PoisonRAG_seed3701_alpha0.0001_lr1e-05.pkl", type=str)
    parser.add_argument("--save_dir", type=str, default="G:/AgentGAD/BlindGuard/MA/results/ASR/")
    parser.add_argument("--model_type", type=str, default="gpt-4o-mini")
    parser.add_argument("--samples", type=int, default=60)
    parser.add_argument("--topk", type=int, default=3)
    parser.add_argument("--defend_type", type=str, default="XGGuard", choices=["SCL", "TAM", "Dominant", "PREM", "XGGuard"])
...
async def main(): 
    ...
    for d in tqdm(dataset): 
        ...
        query = d["query"]
        context = d["adv_texts"]
        agwd = AgentGraphWithDefense(adj_m, system_prompts, attacker_idxes,
                                     model_type=args.model_type)  # agent graph with defense
        try:
            # if args.model_type == "qwen3-30b-a3b":
            #     agwd = AgentGraphWithDefense(adj_m, system_prompts, attacker_idxes, model_type="qwen/qwen3-30b-a3b")  # agent graph with defense
            # else:
