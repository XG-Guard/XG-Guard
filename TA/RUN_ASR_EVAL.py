...
parser.add_argument("--save_dir", type=str, default="G:/AgentGAD/BlindGuard/MA/results/ASR_2/")
...
PATH_CONFIG = {
    ...
    "PI-CSQA": {
        ...
        "gnn_checkpoint_path": "G:/AgentGAD/BlindGuard/MA/ckpt/PI-CSQA_seed3701_alpha0.0001_lr1e-05.pkl",
    },
    "PI-GSM8K": {
        "dataset_path": "G:/AgentGAD/BlindGuard/datasets/PI/agent_graph_dataset/gsm8k/test/dataset.json",
        "gnn_checkpoint_path": "G:/AgentGAD/BlindGuard/MA/ckpt/PI-GSM8K_seed3701_alpha0.0001_lr5e-05.pkl",
    },
    "PI-MMLU": {
        "dataset_path": "G:/AgentGAD/BlindGuard/datasets/PI/agent_graph_dataset/mmlu/test/dataset.json",
        "gnn_checkpoint_path": "G:/AgentGAD/BlindGuard/MA/ckpt/PI-MMLU_seed3701_alpha0.0001_lr0.0001.pkl",
    },
}
