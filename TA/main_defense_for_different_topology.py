...
async def defense_communication(ag:AgentGraphWithDefense, gnn: MyGAT, case, adj_m: np.ndarray,  num_dialogue_turns, topk): 
    communication_data = []
    response_embeddings = []
    initial_responses = await ag.afirst_generate(case)
...
async def main(): 
    ...
    for d in tqdm(dataset): 
        ...
        try:
            ...
            communication_data_defense, original_predicts = await defense_communication(agwd, gnn, case, adj_m, num_dialogue_turns, args.topk)
