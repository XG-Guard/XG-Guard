...
def parse_arguments():
    ...
    parser.add_argument("--atk_type", type=str, default="TA")
    parser.add_argument("--expr_type", type=str, default="InjecAgent")
    ...
    parser.add_argument("--dataset_path", type=str, default="G:/AgentGAD/BlindGuard/datasets/TA/agent_graph_dataset/tool_attack/test/dataset.json", help="Save path of the dataset")
    ...
    parser.add_argument("--gnn_checkpoint_path", type=str, default="G:/AgentGAD/BlindGuard/TA/Unsupervised/injecagent/20250711_112721-defend_type_SCL-hiddim_1024-heads_8-layers_2-epochs_50-lr_0.001-dropout_0.2-wd_1e-05.pth")
    parser.add_argument("--save_dir", type=str, default="./result")
    parser.add_argument("--model_type", type=str, default="gpt-4o-mini")
    parser.add_argument("--samples", type=int, default=60)
    
    parser.add_argument("--defend_type", type=str, default="SCL", choices=["SCL", "TAM", "Dominant", "PREM", "Ours"])
    parser.add_argument("--topk", type=int, default=3)
    parser.add_argument("--save_token_result", type=int, default=0)
...
async def main(): 
    ...
    #
    # # 打印两边的 key 数量
    # print(f"Checkpoint keys: {len(checkpoint_state)}")
    # print(list(checkpoint_state.keys()))
